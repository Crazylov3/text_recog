...
class Trainer():
    def __init__(self, config, pretrained=True, augmentor=ImgAugTransform()):
        ...
        self.gen_data_path = config['dataset']['gen_data_path']
        ...
        self.optimizer = AdamW(self.model.parameters(), lr=config["optimizer"]["max_lr"], betas=(0.9, 0.98), eps=1e-09)
        ...
        self.train_gen = self.data_gen(os.path.join(self.gen_data_path, 'train_{}'.format(self.dataset_name)),
